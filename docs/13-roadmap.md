...
- [x] 305 Rust tests (core unit + integration + adversarial + boundary + stress + CLI unit & integration + engine + JWT auth + sandbox security), 76 benchmark cases across 17 groups, 0 failures
