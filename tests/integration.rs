...
"#,
    ...
    let state = AppState {
        ...
        per_sandbox_tls: std::sync::Arc::new(dashmap::DashMap::new()),
        per_sandbox_metadata: std::sync::Arc::new(dashmap::DashMap::new()),
        peer_ip_to_sandbox_id: std::sync::Arc::new(dashmap::DashMap::new()),
